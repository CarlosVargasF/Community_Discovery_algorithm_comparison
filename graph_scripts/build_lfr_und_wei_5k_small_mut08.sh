...
#Parameters: -N 5000 -k 20 -maxk 50 -minc 10 -maxc 50 -mut 0.8 -beta 1.5
...
do
	for iter in $(seq 0 9)	
	do
		$script_full_path/lfrbench_udwov.exe -N 5000 -k 20 -maxk 50 -minc 10 -maxc 50 -muw ${muw} -mut ${mut} -name lfr_ut_${mut}_uw_${muw}_rep_${iter} -beta 1.5 -cnl 1 
	done
done

#Moving output files to corresponding sub-folder

dest_path="../LFR_benchmarks_for_testing/undirected_weighted/lfr_n_5k_sz_small_ut_08"
